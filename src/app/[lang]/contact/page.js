                ...
                <div className="container mx-auto px-4">
                    <div className="grid lg:grid-cols-3 gap-16">
                        ...
                        <div className="space-y-12 animate-slide-up delay-200">
                            ...
                            <div className="space-y-8">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <a href={`mailto:${t.header.email}`} className="headline-small text-[var(--on-surface)] hover:text-[var(--primary)] transition-colors">
                                            {t.header.email}
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    <div className="w-12 h-12 rounded-2xl bg-[var(--tertiary-container)] text-[var(--tertiary)] flex items-center justify-center flex-shrink-0">
                            ...
                            <div className="p-8 rounded-[var(--shape-extra-large)] bg-eteq-gradient text-white shadow-[var(--elevation-3)]">
                                <span className="material-symbols-outlined text-4xl mb-4">verified</span>
                                <p className="headline-small font-bold mb-2">35+ Years</p>
                                <p className="body-large opacity-90">Of senior engineering leadership delivered directly to you.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                        {t.trustBuilders.stats.slice(0, 6).map((stat, index) => (
                            ...
                            >
                                ...
                                <div className="headline-small font-bold text-[var(--on-surface)] mb-1">{stat.value}</div>
                                <div className="label-small text-[var(--on-surface-variant)] uppercase tracking-wider">{stat.label}</div>
                            </div>
                        ))}
                    </div>
                </div>
