                ...
                <div className="relative overflow-hidden rounded-[var(--shape-extra-large)] bg-eteq-gradient-alt shadow-[var(--elevation-4)] p-12 md:p-24 text-center animate-scale-in">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
                            <a
                                href="#contact"
                                className="w-full sm:w-auto px-10 py-4 bg-white text-[var(--primary)] rounded-full font-bold text-lg shadow-[var(--elevation-2)] hover:shadow-[var(--elevation-3)] hover:scale-105 active:scale-95 transition-all inline-block"
                            >
                                {t.cta.cta1}
                            </a>
                            <a
                                href={`mailto:${t.header.email}`}
                                className="w-full sm:w-auto px-10 py-4 border-2 border-white/30 text-white rounded-full font-bold text-lg hover:bg-white/10 transition-all inline-block"
                            >
                                {t.cta.cta2}
                            </a>
                        </div>
