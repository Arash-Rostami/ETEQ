                    ...
                    <div className="relative bg-[var(--surface)] rounded-[var(--shape-extra-large)] shadow-[var(--elevation-3)] overflow-hidden animate-fade-in">
                        ...
                        <div className="grid lg:grid-cols-2 items-stretch">
                            ...
                            <div className="p-10 lg:p-16 flex flex-col justify-center">
                                ...
                                <a
                                    href="#contact"
                                    className="w-fit flex items-center px-8 py-3 bg-[var(--primary)] text-[var(--on-primary)] rounded-full hover:shadow-[var(--elevation-2)] hover:scale-105 active:scale-95 transition-all font-bold label-large inline-flex"
                                >
                                    {t.founder.cta}
