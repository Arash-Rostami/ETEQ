            ...
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-16 animate-slide-up">
                    ...
                    <p className="body-large text-[var(--on-surface-variant)]">
                        Specialized engineering strategy and operational consulting tailored for high-precision manufacturing sectors.
                    </p>
                </div>
                ...
                <div className="mt-24 pt-12 border-t border-[var(--outline)]/10 text-center opacity-40">
                    <p className="label-large uppercase tracking-[0.4em] text-[var(--on-surface-variant)] mb-10">Global Experience</p>
