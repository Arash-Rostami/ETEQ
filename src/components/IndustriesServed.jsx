                ...
                <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                    {t.industries.list.map((industry, index) => (
                        ...
                        >
                            ...
                            <span className={`label-large transition-colors font-bold uppercase tracking-wider ${activeIndustry === index ? 'text-[var(--primary)]' : 'text-[var(--on-surface)] group-hover:text-[var(--primary)]'}`}>
                                {industry}
                            </span>
                        </div>
                    ))}
