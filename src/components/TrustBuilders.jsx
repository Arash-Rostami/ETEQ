        ...
        <section className="py-20 bg-[var(--background)] relative overflow-hidden">
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center max-w-4xl mx-auto mb-16 animate-slide-up">
                    ...
                    <div className="h-1.5 w-20 bg-eteq-gradient mx-auto rounded-full mb-6"></div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-6">
                    {stats.map((stat, index) => (
                        <div
                            key={index}
                            className="group relative bg-[var(--surface-container)] p-6 rounded-[var(--shape-large)] border border-[var(--outline)]/10 shadow-[var(--elevation-1)] hover:shadow-[var(--elevation-3)] hover:-translate-y-1 transition-all duration-500 animate-fade-in flex flex-col items-center text-center"
