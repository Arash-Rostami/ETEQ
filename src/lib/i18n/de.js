export const de = {
    ...
    whyChoose: {
        title: "Warum ETEQ",
        visualTitle: "Exzellenz durch Design",
        visualDescription: "Datengesteuert, verfeinert durch 35 Jahre globale Engineering-Erfahrung.",
        points: [
            { title: "Direkter Expertenzugang", description: "Arbeiten Sie direkt mit dem Senior-Management." },
            { title: "Jahrzehntelange Führung", description: "35 Jahre nachgewiesene Erfolgsbilanz." },
            { title: "Nachhaltige Ergebnisse", description: "Echte Wirkung auf den CO₂-Fußabdruck." },
            { title: "Branchenübergreifend", description: "Tiefes Wissen in verschiedenen Sektoren." },
            { title: "Globales Management", description: "Erfahrung in internationaler Projektabwicklung." },
            { title: "Operational Excellence", description: "Optimierung jedes Produktionsaspekts." },
            { title: "Lean Six Sigma", description: "Datengestützte Verbesserungsmethodik." },
            { title: "Strategische Beratung", description: "Hochwertige Beratung für langfristiges Wachstum." }
        ]
    },
    founder: {
    ...
    aboutPage: {
        ...
        results: {
            ...
            stats: [
                ...
                { value: "7.400+", label: "Gesparte Stunden", icon: "schedule" }
            ]
        },
        expertise: {
